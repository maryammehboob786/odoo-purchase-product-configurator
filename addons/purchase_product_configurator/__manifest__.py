...
* pick the product attributes (variants, "no variant" options and custom
  values, e.g. the chamber customization),
* tick the *optional products* linked to the main product (e.g. the upgrades
  of a hyperbaric chamber), which are added as extra purchase order lines.
